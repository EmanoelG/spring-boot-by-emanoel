...
import br.com.emanoel.habilidades.security.jwt.JwtConfigurer;
import br.com.emanoel.habilidades.security.jwt.JwtTokenProvider;
...
public class SecurityConfig extends WebSecurityConfiguration {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.httpBasic().disable().csrf(AbstractHttpConfigurer::disable)
				...
				.cors().and().apply(new JwtConfigurer(jwtTokenProvider)).and().build();
